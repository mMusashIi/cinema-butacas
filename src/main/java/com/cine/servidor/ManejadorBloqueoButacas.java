 ...
 *   3. Si el cliente confirma la compra → lock se convierte en BOOKED.
 *   4. Si el cliente cancela → lock se libera → FREE.
 *   5. Si el cliente se desconecta o expira el timeout (2 min) → lock
 *      se libera automáticamente → FREE (y se notifica a todos).
 *
