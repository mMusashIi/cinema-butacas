...
public final class Protocolo {
    ...
    public static final String OBTENER_SALA_CONFIG = "OBTENER_SALA_CONFIG";
    ...
    public static final String RESPUESTA_SALA_CONFIG = "RESPUESTA_SALA_CONFIG";
    public static final String RESPUESTA_RESERVAS = "RESPUESTA_RESERVAS";
    public static final String RESPUESTA_BOLETAS = "RESPUESTA_BOLETAS";
    /** Respuesta al comando CONTEO_BUTACAS. Formato: "total|libres|ocupados" */
    public static final String RESPUESTA_CONTEO  = "RESPUESTA_CONTEO";
